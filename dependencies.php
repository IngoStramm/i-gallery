...
/**
 * ig_register_required_plugins
 *
 * @param  array $plugin_array
 * @return array
 */
function ig_register_required_plugins($plugin_array)
{
...
add_action('admin_notices', 'ig_admin_notice__warning');

/**
 * ig_admin_notice__warning
 *
 * @return string
 */
function ig_admin_notice__warning()
{
    ...
    $need_plugin = false;
    $plugins = ig_register_required_plugins($required_plugins);
