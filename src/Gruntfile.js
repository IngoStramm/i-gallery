...
module.exports = function (grunt) {
    ...
    var moradaIdealConfig = {
        ...
        jshint: {
            ...
            all: [
                'Gruntfile.js',
                '<%= dirs.js %>/i-gallery.js',
                '<%= dirs.js %>/i-gallery-admin.js'
            ]
        },
        ...
        uglify: {
            dist: {
                files: {
                    '<%= dirs.js %>/i-gallery.min.js': [
                        '<%= dirs.js %>/i-gallery.js'    // Custom JavaScript
                    ],
                    '<%= dirs.js %>/i-gallery-admin.min.js': [
                        '<%= dirs.js %>/i-gallery-admin.js'    // Custom JavaScript
                    ]
                }
            }
        },
